...
class CloudCampMain {
    ...
    public static final String COL_NUM_ATTENDEES = "Attendee no.";
    public static final String COL_1 = "Barcode no.";
    public static final String COL_ORDER_DATE = "Order Date";
    public static final String COL_BUYER_FIRST_NAME = "Buyer Surname Name ";
    ...
    public static final String COL_LAST_NAME = "Surname";
    ...
    public static final String COL_14 = "Device no.";
    ...
    public static final String COL_ORDER_NUM = "Order no.";
    ...
    public static final String COL_HOME_STATE = "Home State/Province";
    public static final String COL_HOME_ZIP = "Home Postcode";
    public static final String COL_HOME_COUNTRY = "Home Country";
    public static final String COL_HOME_PHONE = "Home Phone";
    public static final String COL_CELL_PHONE = "Mobile Phone";
    ...
    public static final String COL_SHIP_STATE = "Shipping State/Province";
    public static final String COL_SHIP_ZIP = "Shipping Postcode";
    ...
    public static final String COL_WORK_STATE = "Work State/Province";
    public static final String COL_WORK_ZIP = "Work Postcode";
    ...
    private static String Q_1_PROMPT = "What topic or issue are you interested in discussing at this event? ";
    private static String Q_1_TYPE   = "text";

    private static String Q_2_PROMPT = "Would you like to receive Cloud Computing-related info from our Sponsors?";
    private static String Q_2_TYPE = "checkbox";

    private static String Q_3_PROMPT = "What platform and/or programming language does your application run on?";
    private static String Q_3_TYPE   = "text";

    private static String Q_4_PROMPT = "What dependencies does your application have (i.e. active directory, interlinked processes)";
    private static String Q_4_TYPE   = "text";
    
    private static String Q_5_PROMPT = "Enter a short description & type the application you want to run in the cloud (Type: ERP, CRM, workflow, custom billing app, etc.)";
    private static String Q_5_TYPE   = "text";
    
    private static String Q_6_PROMPT = "What other characteristics does your application have (business criticality, risks, regulations, fluctuations of compute capacity, etc.)";
    private static String Q_6_TYPE   = "text";
    
    private static String Q_7_PROMPT = "URL Twitter";
    private static String Q_7_TYPE   = "text";
    
    private static String Q_8_PROMPT = "Would you like to be notified of job opportunities?";
    private static String Q_8_TYPE   = "checkbox";
    
    private static String Q_9_PROMPT = "What city would you like CloudCamp to come?";
    private static String Q_9_TYPE   = "text";
    
    private static String Q_10_PROMPT = "What type of ISV do you work for?";
    private static String Q_10_TYPE   = "text";
    ...
    public static Date dateFromString(String s) {
        Date date = new Date();
        try {
            date = new SimpleDateFormat("dd-MMM-yy", Locale.ENGLISH).parse(s);
    ...
    public static void main(String[] args) throws IOException {
        ...
        //--------------- Process args -----------------
        if(args.length < 2) {
            System.out.println("Usage: java AttendEvent input_file output_file");
            return;
        }
        ...
        while ((nextLine = reader.readNext()) != null) {
            ...
            event_id = Integer.parseInt( nextLine[0] );
            if(event_id != previous_event_id) {
                if(previous_event_id != -1) { 
                    sql_bw.printf(UPDATE_ATTENDEES_TEMPLATE, previous_event_id, previous_event_id); 
                    sql_bw.println("-- End of event " + previous_event_id);
                    sql_bw.println();
                }

                sql_bw.println("-- Start of event " + event_id);
                ...
                sql_bw.printf(CUSTOM_QUESTION_TEMPLATE, event_id, Q_3_PROMPT, Q_3_TYPE);
                sql_bw.printf(CUSTOM_QUESTION_TEMPLATE, event_id, Q_4_PROMPT, Q_4_TYPE);
                sql_bw.printf(CUSTOM_QUESTION_TEMPLATE, event_id, Q_5_PROMPT, Q_5_TYPE);
                sql_bw.printf(CUSTOM_QUESTION_TEMPLATE, event_id, Q_6_PROMPT, Q_6_TYPE);
                sql_bw.printf(CUSTOM_QUESTION_TEMPLATE, event_id, Q_7_PROMPT, Q_7_TYPE);
                sql_bw.printf(CUSTOM_QUESTION_TEMPLATE, event_id, Q_8_PROMPT, Q_8_TYPE);
                sql_bw.printf(CUSTOM_QUESTION_TEMPLATE, event_id, Q_9_PROMPT, Q_9_TYPE);
                sql_bw.printf(CUSTOM_QUESTION_TEMPLATE, event_id, Q_10_PROMPT, Q_10_TYPE);
                sql_bw.println();
            }
            ...
            String q3_answer = getCell(nextLine, Q_3_PROMPT).trim();
            String q4_answer = getCell(nextLine, Q_4_PROMPT).trim();
            String q5_answer = getCell(nextLine, Q_5_PROMPT).trim();
            String q6_answer = getCell(nextLine, Q_6_PROMPT).trim();
            String q7_answer = getCell(nextLine, Q_7_PROMPT).trim();
            String q8_answer = getCell(nextLine, Q_8_PROMPT).trim();
            String q9_answer = getCell(nextLine, Q_9_PROMPT).trim();
            String q10_answer= getCell(nextLine, Q_10_PROMPT).trim();
            ...
            if(!q3_answer.equals(""))
                sql_bw.printf(CUSTOM_ANSWER_TEMPLATE, event_id, Q_3_PROMPT, email, q3_answer);

            if(!q4_answer.equals(""))
                sql_bw.printf(CUSTOM_ANSWER_TEMPLATE, event_id, Q_4_PROMPT, email, q4_answer);

            if(!q5_answer.equals(""))
                sql_bw.printf(CUSTOM_ANSWER_TEMPLATE, event_id, Q_5_PROMPT, email, q5_answer);

            if(!q6_answer.equals(""))
                sql_bw.printf(CUSTOM_ANSWER_TEMPLATE, event_id, Q_6_PROMPT, email, q6_answer);

            if(!q7_answer.equals(""))
                sql_bw.printf(CUSTOM_ANSWER_TEMPLATE, event_id, Q_7_PROMPT, email, q7_answer);

            if(!q8_answer.equals(""))
                sql_bw.printf(CUSTOM_ANSWER_TEMPLATE, event_id, Q_8_PROMPT, email, q8_answer);

            if(!q9_answer.equals(""))
                sql_bw.printf(CUSTOM_ANSWER_TEMPLATE, event_id, Q_9_PROMPT, email, q9_answer);

            if(!q10_answer.equals(""))
                sql_bw.printf(CUSTOM_ANSWER_TEMPLATE, event_id, Q_10_PROMPT, email, q10_answer);
