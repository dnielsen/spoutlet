...
sudo sed -i "s/\(disable_functions = *\).*/\1/" /etc/php5/cli/php.ini
sudo sed -i "s/\(memory_limit = *\).*/\1-1/" /etc/php5/cli/php.ini
sudo sed -i "s/.*\(date.timezone *=\).*/\1 America\/Los_Angeles/" /etc/php5/cli/php.ini
sudo sed -i "s/\(memory_limit = *\).*/\1${memory_limit}/" /etc/php5/apache2/php.ini
sudo sed -i "s/.*\(date.timezone *=\).*/\1 America\/Los_Angeles/" /etc/php5/apache2/php.ini
echo
