...
def initialize_upload(options):
  ...
  insert_request = youtube.videos().insert(
    ...
    media_body=MediaFileUpload(options.file, mimetype=options.mime, chunksize=-1, resumable=True)
  )
...
if __name__ == '__main__':
  ...
  parser.add_option("--mime", dest="mime", help="Mime type of video file")
  ...
  elif options.mime is None:
    exit("Please specify a valid mime-type using the --mime= parameter.")
  else:
