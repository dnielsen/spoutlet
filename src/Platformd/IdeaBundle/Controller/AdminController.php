...
class AdminController extends Controller
{
    ...
    public function eventAction(Request $request, $groupSlug, $eventId) {
        ...
        $form = $this->container->get('form.factory')->createNamedBuilder('form', 'event', $event)
            ...
            ->add('startsAt',           'datetime',         array('date_widget'  => 'single_text', 'time_widget' => 'single_text', 'with_seconds' => 'false', 'required' => '0'))
            ->add('endsAt',             'datetime',         array('date_widget'  => 'single_text', 'time_widget' => 'single_text', 'with_seconds' => 'false', 'required' => '0'))
