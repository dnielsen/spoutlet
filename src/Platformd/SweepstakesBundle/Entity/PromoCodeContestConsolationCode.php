...
/**
 * @ORM\Table(name="promo_code_contest_consolation_code")
 * @ORM\Entity(repositoryClass="Platformd\SweepstakesBundle\Entity\PromoCodeContestConsolationCodeRepository")
 */
class PromoCodeContestConsolationCode extends AbstractCode
{
    /**
     * @ORM\JoinColumn(onDelete="CASCADE")
     * @ORM\ManyToOne(targetEntity="Platformd\SweepstakesBundle\Entity\Sweepstakes", inversedBy="consolationCodes", cascade={"persist", "remove", "merge"})
     */
    protected $contest;
