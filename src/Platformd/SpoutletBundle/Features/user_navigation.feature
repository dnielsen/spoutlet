...
Feature: User Navigation
  ...
  Scenario: The "Japan" site's user navigation menu has the correct items
    ...
    Then the user navigation menu should be:
      ...
      | プロファイル             | /app_test.php/account/profile                          | http://japan.alienwarearena.local/app_test.php/account/profile/          |
  ...
  Scenario: The "China" site's user navigation menu has the correct items
    ...
    Then the user navigation menu should be:
      ...
      | 个人形象          | /app_test.php/account/profile                          | http://china.alienwarearena.local/app_test.php/account/profile/                        |
