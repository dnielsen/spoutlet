...
/**
 * Platformd\SpoutletBundle\Entity\GroupDiscussionPost
 *
 * @ORM\Table(name="pd_group_discussion_post")
 * @ORM\Entity(repositoryClass="Platformd\SpoutletBundle\Entity\GroupDiscussionPostRepository")
 */
class GroupDiscussionPost implements ReportableContentInterface
{
    ...
    /**
     *
     * @var \Platformd\SpoutletBundle\Entity\GroupDiscussion
     * @ORM\ManyToOne(targetEntity="Platformd\SpoutletBundle\Entity\GroupDiscussion")
    ...
    /**
     * @return \Platformd\SpoutletBundle\Entity\GroupDiscussion
     */
