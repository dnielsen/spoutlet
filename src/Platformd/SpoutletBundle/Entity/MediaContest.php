...
/**
 * Platformd\SweepstakesBundle\Entity\MediaContest
 *
 * @ORM\Entity(repositoryClass="Platformd\SweepstakesBundle\Entity\MediaContestRepository")
 */
class MediaContest extends AbstractEvent
{
    /**
