...
/**
 * Platformd\GroupBundle\Entity\GroupMembershipAction
 *
 * @ORM\Table(name="pd_group_membership_actions")
 * @ORM\Entity(repositoryClass="Platformd\GroupBundle\Entity\GroupMembershipActionRepository")
 */
class GroupMembershipAction
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Platformd\GroupBundle\Entity\Group", inversedBy="membershipActions")
